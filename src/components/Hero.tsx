...
const Hero = () => {
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[120px] px-5 pb-20 theme-bg-primary transition-colors duration-300 bg-[radial-gradient(circle_at_50%_50%,#0f172a_0%,#020617_100%)]">
